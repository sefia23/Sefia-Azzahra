...
<body>
    ...
    /* 
        ...
        */
    $kids = array ("mike", "Dustin", "Will","Luccas", "Max", "Eleven");
    print_r($kids);
    // Lengkapi di sini
    echo"<br>";
    ...
    echo "<br>";
    echo "Total Kids: "; 
    $kids = ["Mike","Dustin", "Will","Luccas", "max", "Eleven"];
    echo count ($kids);
    ...
    /*
        ...
        */
        ...
        $Name = array (
            ...
            array("Name" => "Eleven", "Age" => "12", "Aliases" => "E1", "Status" => "Alive"),
